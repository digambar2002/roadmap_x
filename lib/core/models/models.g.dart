...
void _milestoneSerialize(
  ...
  writer.writeBool(offsets[1], object.isCollapsed);
...
Milestone _milestoneDeserialize(
  ...
  object.id = id;
  object.isCollapsed = reader.readBool(offsets[1]);
...
void _scheduleItemSerialize(
  ...
  writer.writeString(offsets[1], object.goalUid);
...
ScheduleItem _scheduleItemDeserialize(
  ...
  object.goalUid = reader.readString(offsets[1]);
  object.id = id;
